...
import { pickProfileString } from '@ramsoft-builder/gstr2b/utils/helpers';
import { catchError, of, switchMap } from 'rxjs';

@Injectable({ providedIn: 'root' })
export class Gstr2bProfileService {
  ...
  constructor() {
    toObservable(this.authStore.user)
      ...
      .subscribe((prof) => {
        ...
        this.legalName.set(
          pickProfileString(p, ['legal_name', 'legalName', 'companyName', 'name']),
        );
