...
import type {
  ...
  Gstr2bDocRow,
  Gstr2bSummaryRow,
} from '@ramsoft-builder/gstr2b/models/entities';
import type { Gstr2bItcTab, Gstr2bMainTab } from '@ramsoft-builder/gstr2b/models/enums';
import {
...
} from '@ramsoft-builder/gstr2b/utils/constants';
import {
  gstr22bLogicalError,
...
@Component({
  selector: 'lib-gstr2b-summary-page',
  standalone: true,
  imports: [JsonPipe, RouterLink],
  templateUrl: './gstr2b-summary.page.html',
  styleUrl: './gstr2b-summary.page.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: { class: 'block min-h-[60vh]' },
})
export class Gstr2bSummaryPageComponent {
