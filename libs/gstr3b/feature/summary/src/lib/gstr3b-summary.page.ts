...
import { Gstr3bProfileService } from '@ramsoft-builder/gstr3b/data-access/services';
...
@Component({
  selector: 'lib-gstr3b-summary-page',
  standalone: true,
  imports: [JsonPipe, RouterLink],
  templateUrl: './gstr3b-summary.page.html',
  styleUrl: './gstr3b-summary.page.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: { class: 'block min-h-[60vh]' },
})
export class Gstr3bSummaryPageComponent {
  private readonly platformId = inject(PLATFORM_ID);
  private readonly destroyRef = inject(DestroyRef);
  private readonly route = inject(ActivatedRoute);
  private readonly api = inject(Gstr3bApiService);
  readonly profile = inject(Gstr3bProfileService);
