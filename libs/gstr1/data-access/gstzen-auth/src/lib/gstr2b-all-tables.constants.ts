import type { Gstr2bCpSummRow, Gstr2bDocRow } from './gstr2-2b.models';

export type Gstr2bAllTablesSubTab = 'supplier' | 'document';

export interface Gstr2bTableColumnDef<T extends string = string> {
  readonly id: string;
...
export const GSTR2B_SUPPLIER_TABLE_COLUMNS: readonly Gstr2bTableColumnDef<
  keyof Gstr2bCpSummRow
>[] = [
...
export const GSTR2B_DOCUMENT_TABLE_COLUMNS: readonly Gstr2bTableColumnDef<
  keyof Gstr2bDocRow
>[] = [
  { id: 'supplierGstin', label: 'GSTIN of supplier', field: 'supplierGstin', locked: true },
  { id: 'tradeName', label: 'Trade/legal name', field: 'tradeName' },
