...
type Gstr1EcomaAmendTab = 'tcs' | 'ninefive';
...
@Component({
  selector: 'lib-gstr1-ecoma-amend-record-page',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './gstr1-ecoma-amend-record.page.html',
  styleUrl: './gstr1-ecoma-amend-record.page.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: { class: 'block min-h-[60vh]' },
})
export class Gstr1EcomaAmendRecordPageComponent {
  ...
  readonly ecoOperatorGstin = signal('');
  readonly ecoTab = signal<Gstr1EcomaAmendTab>('tcs');
  ...
  selectTab(tab: Gstr1EcomaAmendTab): void {
    this.ecoTab.set(tab);
  }
