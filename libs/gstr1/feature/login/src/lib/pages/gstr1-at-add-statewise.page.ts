...
export const GSTR1_ADVANCE_DIFF_PERCENT_OPTIONS = [
  { label: '65%', value: '0.65' },
  { label: '70%', value: '0.70' },
  { label: '75%', value: '0.75' },
  { label: '80%', value: '0.80' },
...
@Component({
  selector: 'lib-gstr1-at-add-statewise-page',
  standalone: true,
  imports: [JsonPipe, RouterLink, ReactiveFormsModule],
  templateUrl: './gstr1-at-add-statewise.page.html',
  styleUrl: './gstr1-b2b-add-record.page.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: { class: 'block min-h-[60vh]' },
})
export class Gstr1AtAddStatewisePageComponent {
  ...
  readonly apiName = signal<Gstr1DownloadApiName>('at');
