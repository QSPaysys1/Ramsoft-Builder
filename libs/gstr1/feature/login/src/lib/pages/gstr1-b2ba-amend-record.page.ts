...
@Component({
  selector: 'lib-gstr1-b2ba-amend-record-page',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './gstr1-b2ba-amend-record.page.html',
  styleUrl: './gstr1-b2ba-amend-record.page.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: { class: 'block min-h-[60vh]' },
})
export class Gstr1B2baAmendRecordPageComponent {
  ...
  /** Selected financial year (portal dropdown), e.g. 2025-26 */
