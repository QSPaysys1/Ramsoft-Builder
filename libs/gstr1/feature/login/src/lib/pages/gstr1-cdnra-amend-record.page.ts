...
@Component({
  selector: 'lib-gstr1-cdnra-amend-record-page',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './gstr1-cdnra-amend-record.page.html',
  styleUrl: './gstr1-cdnra-amend-record.page.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: { class: 'block min-h-[60vh]' },
})
export class Gstr1CdnraAmendRecordPageComponent {
