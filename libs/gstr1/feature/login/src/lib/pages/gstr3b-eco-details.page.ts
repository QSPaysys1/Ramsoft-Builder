...
@Component({
  selector: 'lib-gstr3b-eco-details-page',
  standalone: true,
  imports: [JsonPipe, RouterLink, FormsModule],
  templateUrl: './gstr3b-eco-details.page.html',
  styleUrl: './gstr3b-sup-details.page.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: { class: 'block min-h-[60vh]' },
})
export class Gstr3bEcoDetailsPageComponent {
  ...
  readonly draftEcoDetails = signal<Gstr3bEcoDetails>(emptyGstr3bEcoDetails());
  ...
  touchEcoDetails(): void {
    const draft = structuredClone(this.draftEcoDetails());
  ...
  cancel(): void {
    this.draftEcoDetails.set(structuredClone(this.retsaveForm().eco_dtls));
    ...
    try {
      ...
      if (!retsumErr) {
        ...
        if (form) {
          ...
          this.draftEcoDetails.set(structuredClone(form.eco_dtls));
