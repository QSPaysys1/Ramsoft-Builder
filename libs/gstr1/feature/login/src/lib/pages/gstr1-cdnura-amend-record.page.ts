...
@Component({
  selector: 'lib-gstr1-cdnura-amend-record-page',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './gstr1-cdnura-amend-record.page.html',
  styleUrl: './gstr1-cdnura-amend-record.page.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: { class: 'block min-h-[60vh]' },
})
export class Gstr1CdnuraAmendRecordPageComponent {
  ...
  readonly infoBannerVisible = signal(true);
  ...
  updateNoteNo(value: string): void {
    this.noteNo.set(value);
  }
  ...
  refreshPage(): void {
    this.noteNo.set('');
    this.infoBannerVisible.set(true);
  }

  dismissInfoBanner(): void {
    this.infoBannerVisible.set(false);
  }
