...
@Component({
  selector: 'lib-gstr1-ata-amend-record-page',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './gstr1-ata-amend-record.page.html',
  styleUrl: './gstr1-ata-amend-record.page.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: { class: 'block min-h-[60vh]' },
})
export class Gstr1AtaAmendRecordPageComponent {
